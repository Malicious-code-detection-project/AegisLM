"""AegisLM Unsloth QLoRA SFT training script."""
...
from unsloth import FastLanguageModel  # type: ignore[import-not-found] # noqa: E402
from trl import SFTTrainer  # type: ignore[import-not-found] # noqa: E402
from transformers import TrainingArguments  # type: ignore[import-not-found] # noqa: E402
...
def main() -> None:
    ...
    print(f"[INFO] Loading model '{model_id}' in 4-bit with Unsloth...")
    ...
    # Dynamic adjustment for tiny SFT dataset to avoid zero-steps errors in gradient accumulation
    ...
    training_args = TrainingArguments(
        ...
        save_strategy="no",  # Don't save checkpoint steps for tiny PoC
        report_to="none",  # Disable wandb reporting for local dry-run
    )
